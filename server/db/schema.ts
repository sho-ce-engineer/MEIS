...
export const facilities = pgTable(
  'facilities',
  {
    ...
    facilitiesStatus: varchar('facilities_status', { length: 50 }).default(
      'active',
    ),
...
export const inspectionItems = pgTable(
  'inspection_items',
  {
    ...
    inspectionComponentType: varchar('inspection_component_type', {
      length: 50,
    }),
...
export const inspectionResults = pgTable(
  ...
  (table) => [
    ...
    foreignKey({
      ...
      foreignColumns: [
        equipmentLedger.equipmentId,
        equipmentLedger.facilityCode,
      ],
...
export const equipmentLedger = pgTable(
  'equipment_ledger',
  {
    id: serial().primaryKey().notNull(),
    ...
    equipmentStorageLocation: varchar('equipment_storage_location', {
      length: 255,
    }),
  ...
  (table) => [
    ...
    unique('equipment_ledger_equipment_id_facility_code_key').on(
      table.equipmentId,
      table.facilityCode,
    ),
  ],
...
export const announcements = pgTable('announcements', {
  ...
  importanceLevel: varchar('importance_level', { length: 50 })
    .default('normal')
    .notNull(),
...
export const employees = pgTable(
  ...
  (table) => [
    ...
    unique('employees_facility_code_employee_code_key').on(
      table.facilityCode,
      table.employeeCode,
    ),
